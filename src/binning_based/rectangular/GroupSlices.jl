...
# and is MIT licensed (https://github.com/mcabbott/GroupSlices.jl/blob/master/LICENSE)
# Mained here for future stability, because the registered package is only v0.0.3.
