...
function entropy(e::Kaniadakis, probs::Probabilities)
    κ = e.κ
...
function entropy_maximum(e::Kaniadakis, L::Int)
    error("entropy_maximum not implemeted for Kaniadakis entropy yet")
end
