...
# Constructors
@test Correa(Shannon()) isa Correa{<:Shannon}
...
npts = 1000000
ea = information(Correa(m = 100), rand(npts))
ea_n = information(Correa(Shannon(base = ℯ), m = 100), randn(npts))
ea_n3 = information(Correa(Shannon(base = 3), m = 100), randn(npts))
